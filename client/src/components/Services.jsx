...
const Services = () => {
  return (
    <div className="container relative flex flex-col justify-between h-full max-w-6xl px-10 my-24 mx-auto xl:px-0 mt-5">
      <div className="flex flex-col items-center">
        <h2 className="mb-1 text-3xl font-extrabold font-dancing leading-tight text-light-blue">
          Services
        </h2>
        <p className="text-2xl mb-12 font-roboto font-extrabold text-custom-blue">
