  ...
  return (
    <div>
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="bg-custom-gray max-w-lg p-6 md:p-10 rounded-lg absolute bottom-6 left-4 md:left-auto md:right-6">
          <h1 className="font-roboto text-xl md:text-2xl font-medium tracking-wider text-custom-black mb-4 md:mb-6">
            Where to find us?
          </h1>
          <hr className="border-custom-teal/50 mb-4 md:mb-6"></hr>
          <div className="flex flex-col md:flex-row gap-4 md:gap-10 items-start justify-start">
            <div>
              <h5 className="font-roboto text-custom-black font-medium text-base md:text-lg">
                Address
              </h5>
              <p className="text-custom-teal mb-2 text-xs md:text-sm">
                Oakland Jack London
              </p>
              <p className="text-custom-teal text-xs md:text-sm">
            ...
            <div className="flex flex-col">
              <div className="flex flex-col mb-2">
                ...
                <h6 className="text-custom-teal text-xs md:text-sm">
                  +964 771 856 9787
                </h6>
              </div>
              <div className="flex flex-col">
