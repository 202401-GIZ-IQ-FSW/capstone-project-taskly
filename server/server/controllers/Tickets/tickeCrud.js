...
exports.creatTicket = async(req, res)=>{
    try{
...
exports.getAllTicketById = async(req, res) => {
    try{
...
exports.updateTicket = async(req, res) =>{
    try{
        const updatedTicket = await Ticket.findByIdAndUpdate(req.params.ticketId, req.body, { new: true, runValidators: true });
