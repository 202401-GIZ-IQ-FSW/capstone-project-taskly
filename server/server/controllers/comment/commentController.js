...
const createComment = async(req, res) => {
    ...
    try{
        ...
        res.status(500).json({ error: 'An error occurred while creating the ticket', message: error.message });
      }
};
...
const getAllComments = async (req, res) => {
    ...
    try {
        ...
        res.status(500).json({ error: 'An error occurred while retrieving the comments', message: error.message });
    }
};
...
const getCommentById = async (req, res) => {
    ...
    try {
        ...
        res.status(500).json({ error: 'An error occurred while retrieving the comment', message: error.message });
    }
};
...
const updateCommentById = async (req, res) => {
    ...
    try {
        ...
        res.status(500).json({ error: 'An error occurred while updating the comment', message: error.message });
    }
};
...
const deleteCommentById = async (req, res) => {
    ...
    try {
        ...
        res.status(500).json({ error: 'An error occurred while deleting the comment', message: error.message });
    }
};
